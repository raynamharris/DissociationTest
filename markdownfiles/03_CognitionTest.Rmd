...
## DEG by contrasts
contrast1 <- resvals(contrastvector = c('Region', 'CA1', 'DG'), mypval = 0.05) #1754
contrast2 <- resvals(contrastvector = c('Region', 'CA3', 'DG'), mypval = 0.05) #2252
contrast3 <- resvals(contrastvector = c('Region', 'CA1', 'CA3'), mypval = 0.05) #1268
contrast4 <- resvals(contrastvector = c('Treatment', 'trained', 'yoked'), mypval = 0.05) #423
```
