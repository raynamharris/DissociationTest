...
write.csv(intersection, "./06_GO_MWU/05_combo_intersection.csv", row.names = F)
...
write.csv(cembrowskidissosication, "./06_GO_MWU/05_combo_cembrowskidissosication.csv", row.names = F)
...
write.csv(cognitiondissociation, "./06_GO_MWU/05_combo_cognitiondissociation.csv", row.names = F)
