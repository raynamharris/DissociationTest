...
## sample information
raynacoldata <- read.csv('../data/intermediatefiles/colData.csv')
...
## count data
raynacountdata <-  read.csv('../data/intermediatefiles/countData.csv', check.names = F)
...
ann_colors = list(
  exp =  c(cembrowski = (values=c("#c994c7")), harris = (values=c("#e7298a"))),
  region =  c(dg = (values=c("#a50f15")),  ca3 = (values=c("#238443")), 
             ca1 = (values=c("#08306b"))))
