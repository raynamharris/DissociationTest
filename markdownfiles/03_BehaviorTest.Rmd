...
## PC2 vs PC3
plotPC2PC3(aescolor = pcadata$Region, colorname = "Region", aesshape = pcadata$Group, shapename = "Group", colorvalues = colorvalRegion)

plotPC3PC4(aescolor = pcadata$Region, colorname = "Region", aesshape = pcadata$Group, shapename = "Group", colorvalues = colorvalRegion)
```
...
myhistogram(contrastvector = c('Group', 'trained', 'control'), mypval = 0.1)
...
DEGes$padjmin <- with(DEGes, pmin(padjGrouptrainedcontrol, padjRegionCA1DG ,padjRegionCA3DG, padjRegionCA1CA3 )) # put the min pvalue in a new column
DEGes <- DEGes %>% filter(padjmin < 0.1)

#DEGes$pvalmin <- with(DEGes, pmin(pvalGrouptrainedcontrol, pvalRegionCA1DG ,pvalRegionCA3DG, pvalRegionCA1CA3 )) # put the min pvalue in a new column
...
<<<<<<< HEAD
res <- results(dds, contrast=c('Group', 'trained', 'control'))
=======
res <- results(dds, contrast=c('Group', 'control', 'trained'))
