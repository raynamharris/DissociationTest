...
B <- avoidableshock %>% 
  ...
  scale_y_continuous(name="% Time in 'Shock Zone'") + 
...
plot_grid(A, B, rel_widths = c(1.3, 2), labels = c("A", "B"))

# PC1 vs PC2 for adobe
myplot <- plot_grid(A, B, rel_widths = c(1.3, 2),labels = c("A", "B"))
pdf(file="../figures/03_behaviortest/behavior.pdf", width=7.5, height = 4)
plot(myplot)
dev.off()
