...
write(venn123, "../results/01_cembrowski_venn123.txt")
...
DEGes$padjmin <- with(DEGes, pmin(padjLocationdorsalventral, padjRegionCA1DG ,padjRegionCA3DG, padjRegionCA1CA3 )) # put the min pvalue in a new column
