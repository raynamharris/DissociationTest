...
plotPC1PC2(aescolor = pcadata$region, aesshape = pcadata$location, legendname = "Region Location", colorvalues = colorvalpunch)
plotPC3PC4(aescolor = pcadata$region, aesshape = pcadata$location, legendname = "Region Location", colorvalues = colorvalpunch)
...
contrast1 <- resvals(contrastvector = c('region', 'ca1', 'dg'), mypadj = 0.1)
contrast2 <- resvals(contrastvector = c('region', 'ca3', 'dg'), mypadj = 0.1)
contrast3 <- resvals(contrastvector = c('region', 'ca1', 'ca3'), mypadj = 0.1)
contrast4 <- resvals(contrastvector = c('location', 'd', 'v'), mypadj = 0.1)
...
candidates <- list("Brain Region" = venn123, "Location" = venn4)
...
DEGes$padjmin <- with(DEGes, pmin(pvallocationdv)) # put the min pvalue in a new column
