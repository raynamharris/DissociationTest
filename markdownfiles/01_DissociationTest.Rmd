...
colData <- read.csv('../data/GSE99765_DissociationColData')
rownames(colData) <- colData$RNAseqID
countData <-  read.csv('../data/GSE99765_DissociationCountData', check.names = F, row.names = 1)
```
...
include_graphics('../figures/01_dissocationtest/01_dissocationtest-01.png', auto_pdf = TRUE, dpi = NULL)
```