...
# for adobe
hist1 <- myhistogram(contrastvector = c('Region', 'CA1', 'DG'), mypval = 0.1)
hist4 <- myhistogram(contrastvector = c('Method', 'control', 'dissociated'), mypval = 0.1)
...
GOpvalsMDH <- GOpvals %>%
  #filter(padjMethodcontrolDissociated < 0.1) %>%
  select(gene, padjMethodcontroldissociated)
GOpvalsMDH$logP <- log(GOpvalsMDH$padjMethodcontroldissociated)
