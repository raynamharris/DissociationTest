...
```{r 01_dissociationCC, echo=FALSE}
# input files
input="01_dissociation_GOpvals.csv" 
goAnnotations="goAnnotations.tab" 
goDatabase="go.obo" 
...
- First, I exported the list of overlapping genes from the previous 05_metaanalyses.Rmd file
...
```{r 05_intersectionCC, echo=FALSE}
# input files
...
```{r 05_intersectionMF, echo=FALSE}
# input files
input="05_metaanalyses_intersection_allgenes.csv" 
goAnnotations="goAnnotations.tab" 
goDatabase="go.obo" 
...
```{r 05_intersectionCA1DG_CC, echo=FALSE}
# input files
input="05_metaanalyses_intersection_DGCA1only_allgenes.csv" 
goAnnotations="goAnnotations.tab" 
goDatabase="go.obo" 
goDivision="CC" # either MF, or BP, or CC
...
```{r 05_intersectionCA1DG_MF, echo=FALSE}
# input files
input="05_metaanalyses_intersection_DGCA1only_allgenes.csv" 
goAnnotations="goAnnotations.tab" 
goDatabase="go.obo" 
