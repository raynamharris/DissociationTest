...
# DEGenes by region in stress and issociation
regionstressdissociation <- read.csv("05_combo_regionstressdissociation.csv", header=T)
...
write.csv(regionstressdissociation, "./05_combo_regionstressdissociation.csv", row.names = F)
