...
# save files
write.csv(colData, "../results/02_stress_colData.csv", row.names = F)
write.csv(countData, "../results/02_stress_countData.csv", row.names = T)
```
...
DEGes$padjmin <- with(DEGes, pmin(padjTreatmentshockedhomecage)) # put the min pvalue in a new column

write.csv(as.data.frame(DEGes), "../results/02_stress_DEGes.csv", row.names = F)
```
