...
fourhoursRNA <- subset_df(S2, "RNA fold change (4 h/control), log2", "p-value (4 h)")

fourhoursRNA <- determineChoDEGs(fourhoursRNA)
...
thirtyminRNA <- subset_df(S2, "RNA fold change (30 min/control), log2", "p-value (30 min)")

# prep for volcano plot
thirtyminRNA <- determineChoDEGs(thirtyminRNA)
...
tenmin <- determineChoDEGs(tenmin)
...
fivemin <- determineChoDEGs(fivemin)
