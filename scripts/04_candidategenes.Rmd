...
1. catagorize the genes as differentially expressed or not
1. create a list of just DEG gene names
1. crossreference the list of DEG names with the the dissociated DEGs
