...
Here is the function I wrote to make two heatmaps, one a png and one a pdf. The goal is to have the ~ top 20 genes that are differentially expressed according to treatment.
