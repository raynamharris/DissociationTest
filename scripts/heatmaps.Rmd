...
source("heatmapcolors.R")

# set output file for figures 
knitr::opts_chunk$set(fig.path = '../figures/heatmaps/')
```
...
CA1 <- dissocation_DEGes %>% 
  dplyr::filter(Subfield == "CA1")
CA3 <- dissocation_DEGes %>% 
  dplyr::filter(Subfield == "CA3")
DG <- dissocation_DEGes %>% 
  dplyr::filter(Subfield == "DG")
...
Heatmaps(CA1, dissocation_colors, dissocation_df, "CA1 Dissociation")
Heatmaps(CA3, dissocation_colors, dissocation_df, "CA3 Dissociation")
Heatmaps(DG, dissocation_colors, dissocation_df, "DG Dissociation")
