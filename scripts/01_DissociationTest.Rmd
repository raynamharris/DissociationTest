...
DEGes$padjmin <- with(DEGes, pmin(padjTreatmentdissociatedcontrol, padjSubfieldCA1DG ,padjSubfieldCA3DG, padjSubfieldCA1CA3 )) # put the min pvalue in a new column
