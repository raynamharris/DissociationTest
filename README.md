...
[Here are the analyses](./markdownfiles/05_metaanlyses.Rmd) and [the results.](./markdownfiles/05_metaanlyses.md)

### Figure 4 and 5: Gene Ontology (GO) analyses. 
[Here are the analyses](./markdownfiles/06_GO_MWU/06_GO_MWU.Rmd) and [the results.](./markdownfiles/06_GO_MWU/06_GO_MWU.md)
