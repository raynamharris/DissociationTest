...
**Figure 1: The effects of cellular dissociation on hippocampal transcriptomes**  First, I compare CA1, CA3, and DG hippocampal samples from single individual that were prepared either by homogenization or dissociation. [Here are the analyses](./markdownfiles/01_DissociationTest.Rmd) [and results.](./markdownfiles/01_DissociationTest.md) I spiced up the figures a little in Adobe Illustrator.
