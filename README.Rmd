...
**Supplemental Table 1.** Expression level and fold change of of significant genes (p < 0.05) between dissociated tissue and homogenized tissue. This table shows the log fold change (lfc), p-value (padj), and direction of upregulation for each gene analyzed.
