...
This describes the data analysis workflow that follows tissue collection and RNA sequencing. 
...
This is graphic illustrates the workflow, indicating the order of operations which files are used as input and generated as output from different scripts. 
