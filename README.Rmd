...
This repository contains the R scripts, data, results that for a study about _Hippocampal transcriptomic responses to cellular dissociation_. This research was submitted to the journal _Hippocampus_ in 2017 then was revised and submitted in January 2017. A preprint is [available on BioRxiv](https://www.biorxiv.org/content/early/2019/01/21/153585).
