...
contrast1 <- resvals(contrastvector = c('Punch', 'CA1', 'DG'), mypadj = 0.01)
contrast2 <- resvals(contrastvector = c('Punch', 'CA3', 'DG'), mypadj = 0.01)
contrast3 <- resvals(contrastvector = c('Punch', 'CA1', 'CA3'), mypadj = 0.01)
contrast4 <- resvals(contrastvector = c('Method', 'Homogenized', 'Dissociated'), mypadj = 0.01)
