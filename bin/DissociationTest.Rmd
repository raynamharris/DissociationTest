...
# STXBP6 binds components of the SNARE complex
...
#sum(resMethodHomogDiss$padj < 0.1, na.rm = TRUE) #304
...
#head(assay(rld), 3)
rldd <- assay(rld)
rldpvals <- cbind(rldd, valsMethodHomogDiss, valsMethodYokedTrained, valsPunchCA1DG, valsPunchCA1CA3, valsPunchCA3DG)
#head(rldpvals)
#dim(rldpvals)
#17906    46
...
candidates <- list("CA1 v. DG" = PunchCA1DG,  "yoked vs trained" = MethodYokedTrained, "Homogenized v. Dissociated" = MethodHomogDiss )

prettyvenn <- venn.diagram(
  x = candidates, filename=NULL, lwd=4,
  col = "transparent",
  fill = (values=c("#00441b", "#238b45", "#66c2a4")),
  alpha = 0.5,
...
ann_colors = list(
  Method=  c(Homogenized = (values=c("#e34a33")), Dissociated = (values=c("#fdbb84")),
             Yoked = (values=c("#f1a340")), Trained  = (values=c("#9970ab"))),
