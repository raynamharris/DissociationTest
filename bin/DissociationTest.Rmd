...
knitr::opts_chunk$set(fig.path = '../figures/tpm')
```
...
countbygene <- full_join(geneids, tpm)
...
colData <- colData %>% filter(grepl("Homogenized|Dissociated", Method)) %>% droplevels() ## subsets data
