...
knitr::opts_chunk$set(fig.path = '../figures/dissociatetest/')
```
...
plotPC1PC2(aescolor = pcadata$Punch, legendname = "Punch", colorvalues = colorvalpunch)
plotPC1PC3(aescolor = pcadata$Punch, legendname = "Punch", colorvalues = colorvalpunch)
plotPC2PC3(aescolor = pcadata$Punch, legendname = "Punch", colorvalues = colorvalpunch)
plotPC3PC4(aescolor = pcadata$Punch, legendname = "Punch", colorvalues = colorvalpunch)

## plotting various PC comparisons coloring by punch
plotPC1PC2(aescolor = pcadata$Method, legendname = "Method", colorvalues = colorvalmethod)
plotPC1PC3(aescolor = pcadata$Method, legendname = "Method", colorvalues = colorvalmethod)
plotPC2PC3(aescolor = pcadata$Method, legendname = "Method", colorvalues = colorvalmethod)
plotPC3PC4(aescolor = pcadata$Method, legendname = "Method", colorvalues = colorvalmethod)

#keep just this one for plotting
```
...
```{r VennDiagram, echo=FALSE, echo=FALSE, message=TRUE, comment=FALSE, warning=FALSE, results='hide'}
## DEG by contrasts
...
candidates <- list("CA1 v. DG" = venn1,  "CA1 v. CA3" = venn3,  "CA3 v. DG" = venn2, "Method" = venn4)

pdf("../figures/allregions_onlyhomodiss/prettyvenn.pdf")
...
```{r readcounts, echo=FALSE, message=FALSE,comment=FALSE, warning=FALSE }
readcounts <- read.table("../data/intermediatefiles/slimreadcounts.txt")
str(readcounts)
...
#write.csv(GOpvalsMDH, "../data/intermediatefiles/GOpvalsMDH.csv", row.names = F)
#write.csv(GOpvalsMDH, "GOpvalsMDH.csv", row.names = F)
```