...
colData <- colData %>% 
  filter(grepl("100|101|A|B", Mouse))  %>% 
...
pcamethod <- ggplot(pcadata, aes(PC1, PC2, color=Method, label=name)) +
  ...
  scale_color_manual(values=c("#525252", "#969696", "#f1a340", "#9970ab"))
...
ann_colors = list(Method = c(Homogenized = (values=c("#969696")), Dissociated = (values=c("#525252")), Yoked = (values=c("#f1a340")), Trained = (values=c("#9970ab")),
             CA1 = (values=c("#08306b"))))
